...
export default function AssuranceBoardPage() {
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    apiFetch('assurance/report/?pack=nibras', { token })
  ...
  useEffect(() => {
    ...
    async function listen() {
      try {
        const response = await apiFetchStream('assurance/stream/?pack=nibras', {
          token,
  ...
  return (
    <PageContainer>
      <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }} flexWrap="wrap">
        <Typography variant="h6">Assurance</Typography>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
        Engineering board. It reads the ledger. It does not run payroll, WPS, or Chat.
