...
// Keeps consequence readable; Analysts still see raw fields in Details/ledger.

const RULE_ID = /\bRULE_\d+\b[:\s-]*/gi;
const SNAKE_TOOL = /\b(deny_[a-z0-9_]+|call_host_api|search_knowledge|export_document|code_execute)\b/gi;
...
export function stripEngineJargon(text) {
  ...
  out = out.replace(SNAKE_TOOL, (m) => m.replace(/_/g, ' '));
