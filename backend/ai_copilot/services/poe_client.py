...
try:
    ...
    FASTAPI_POE_AVAILABLE = True
except ImportError:
    FASTAPI_POE_AVAILABLE = False
    fp = None
...
def get_poe_client() -> 'POEClient':
    ...
    global _poe_client
    if not FASTAPI_POE_AVAILABLE:
        raise ImportError("fastapi_poe is not installed. Install ai_copilot dependencies.")
