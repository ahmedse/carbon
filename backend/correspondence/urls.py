...
urlpatterns = [
    ...
    path('<int:pk>/edit/', CorrespondenceViewSet.as_view({'post': 'edit'}),
    ...
    path('<int:pk>/void/', CorrespondenceViewSet.as_view({'post': 'void'}),
         name='correspondence-void'),
    path('<int:pk>/reopen/', CorrespondenceViewSet.as_view({'post': 'reopen'}),
         name='correspondence-reopen'),
