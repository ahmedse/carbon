    ...
    if user_info:
        ...
        if employee:
            ...
            identity_directive = (
                ...
                "get_my_leave_balance, list_my_loans). To REQUEST / SUBMIT leave "
                "(\"I want leave\", \"أريد إجازة\", عارضة / emergency) call "
                "submit_my_leave via call_host_api with requires_confirmation — "
