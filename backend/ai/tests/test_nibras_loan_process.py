"""Nibras loan ``loan.request.lifecycle`` — governance artifact tests.

Verifies the P5b artifacts scaffolded for the Nibras loan lifecycle:
...
Run under the Nibras brand::
    ...
    DJANGO_BRAND=nibras ../.venv/bin/python -m pytest ai/tests/test_nibras_loan_process.py -q
"""
...
PROCESS_ID = "loan.request.lifecycle"
...
def test_objective_predicate_is_a_known_capability():
    ...
    assert predicate == "loan.request.activated_and_scheduled"
