# Generated by Django 5.2.3 on 2026-07-30 12:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0007_group_metadata'),
    ]

    operations = [
        migrations.CreateModel(
            name='PlatformAppConfig',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_id', models.CharField(db_index=True, max_length=50, unique=True)),
